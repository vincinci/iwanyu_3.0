  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Seller Support", href: "/vendor/support" },
      ],
    },
    {
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-white mb-4 md:mb-0">
              ...
              <p className="text-primary-100">
                Subscribe to get special offers, latest products, and exclusive deals.
              </p>
            </div>
            <div className="flex w-full md:w-auto max-w-md">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-l-lg border-0 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-500"
              />
              <button className="px-6 py-3 bg-white text-primary-600 font-medium rounded-r-lg hover:bg-gray-50 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
